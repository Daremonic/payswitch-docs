...
Set `disableBranding` to false to disable PaySwitcher branding.\
...
To disable PaySwitcher branding in the SDK, you may set the `disableBranding` property to true
...
PaySwitcher Flutter SDK supports localization in 6 languages. The default locale is English (en). To override, you can send locale in the appearance object. You may refer the below code for your reference.
