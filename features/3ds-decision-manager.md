...
* The [3DS Decision Manager](https://app.payswitcher.com/3ds) on the PaySwitcher Control Center allows you to configure advanced rules based on payment parameters to decide when to enforce 3DS on card payments for supported processors
...
To test the 3DS Decision Manager, after activating the rule, we can make a Test Payment using the [PaySwitcher Dashboard](https://app.payswitcher.com/sdk)
