---
description: A brief summary of measures taken at PaySwitcher to ensure GDPR compliance
---
...
PaySwitcher plays the role of a ‘Data Processor’ and takes all the below initiatives to ensure compliance.
...
PaySwitcher is engineered with a meticulous focus on safeguarding sensitive data aligning with PCI standards. The application also employs various strategies that encompasses various stage, which includes
...
[Read more](https://docs.payswitcher.com/security-and-compliance/security) about Data security at PaySwitcher.
...
PaySwitcher Payments has a Privacy and Data Protection team and a designated Data Protection Officer to look after Data Protection, Privacy and Compliance Obligations

### Data Protection Agreement

PaySwitcher Master Services Agreement includes a Data Protection Agreement which clearly articulates our privacy commitment to merchants. We have evolved these terms and specifically updated these terms to reflect the GDPR from the perspective of payment processing, and, to facilitate merchants’ compliance assessment and GDPR readiness when using PaySwitcher.
...
Below is the list of sub-processors we use at PaySwitcher, as well as the purpose of their use.
