---
description: Understand the flow of a transaction through PaySwitcher
---
...
**b) Loading the SDK:** After your customer checks out, load the PaySwitcher SDK by initiating it with the client\_secret and publishable\_key
